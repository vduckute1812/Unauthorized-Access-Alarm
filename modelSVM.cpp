...
//     resize(img, img, Size(50,100));
//     imshow("data",img);
//     waitKey(0);

//     Ptr< SVM > svm = Algorithm::load<SVM>("model.dat");


//     HOGDescriptor hog_2(img.size(), Size(10, 20), Size(5, 10), Size(10,10), 9);

//     vector< float > description,description2;

//     hog_2.compute(img, description);
...
//     cout<<svm->predict(data_train);   

//     return 0;
// }

//     HOGDescriptor hog_2(Size(detector_width,detector_height), Size(10, 20), Size(5, 10), Size(10,10), 9);

//     vector< float > description,description2;

//     hog_2.compute(img, description);
//     hog_2.compute(img_2, description2);


//     Mat data = Mat(description).clone();
//     Mat data_2 = Mat(description2).clone();
